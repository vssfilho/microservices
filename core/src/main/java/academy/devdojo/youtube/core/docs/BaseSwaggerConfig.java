...
public class BaseSwaggerConfig {
	...
	private ApiInfo metaData() {
		return new ApiInfoBuilder()
				.title("Another Awesome course from DevDojo <3 Spring Boot Microservice")
				.description("Everybody is a Jedi now")
				.version("1.0")
				.contact(new Contact("Willian Suane as the Jedi Master", "http://devdojo.academy", "willian.suane@devdojo.academy"))
